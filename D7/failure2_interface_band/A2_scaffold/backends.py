...
SCRIPTS = {
    ...
    # NOTE: the REF-5631 trap case for D7 Failure 2 is deliberately NOT
    # registered here. It is only valid against tools_broken.py (band
    # optional) - registering it in this shared file would make the
    # plain `python run_eval.py` battery pick it up and crash against
    # the real, unmodified tools.py. run_failure2.py adds it to
    # backends.SCRIPTS itself, at runtime, for the one run that needs it.
